...
// defined).
    ...
    function keyboardFocusIn(e) {
        ...
        if (!e.target ||
            e.target.readOnly || !ionic.tap.isKeyboardElement(e.target) || !(scrollView = ionic.DomUtil.getParentWithClass(e.target, SCROLL_CONTAINER_CSS))) {
    ...
    function keyboardWaitForResize(callback, isOpening) {
        ...
        waitForResizeTimer = setInterval(function () {
            ...
            if (++count < maxCount &&
                ((!isPortraitViewportHeight(viewportHeight) && !isLandscapeViewportHeight(viewportHeight)) || !ionic.keyboard.height)) {
                return;
            }
